...
class TrajectoryDressUpObject:
    def __init__(self, obj) -> None:
        obj.Proxy = self
        obj.addProperty(
            "App::PropertyLink", "Source", "TrajectoryDressUp", "Trajectory to dress up"
        ).Source = None
        obj.addProperty(
            "App::PropertySpeed", "Speed", "TrajectoryDressUp", "Speed to use"
        ).Speed = 1000
        obj.addProperty(
            "App::PropertyBool",
            "UseSpeed",
            "TrajectoryDressUp",
            "Switch the speed usage on",
        ).UseSpeed = False
        obj.addProperty(
