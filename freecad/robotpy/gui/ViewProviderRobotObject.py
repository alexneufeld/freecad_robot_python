...
class ViewProviderRobotObject:
    def __init__(self, vobj) -> None:
        ...
        self.Axis1Node = self.Axis2Node = self.Axis3Node = self.Axis4Node = self.Axis5Node = self.Axis6node = None
        self.pcDragger = None

    def setDragger(self) -> None:
        assert (self.pcDragger is None)
        self.pcDragger = coin.SoJackDragger()
        self.pcDragger.addMotionCallback(self.sDraggerMotionCallback)
    ...
    def setAxisTo(self, A1: float, A2: float, A3: float, A4: float, A5: float, A6: float, Tcp: FreeCAD.Placement) -> None:
        pass
