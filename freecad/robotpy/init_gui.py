import FreeCADGui
from freecad.robotpy.gui import ICONPATH
from os import path
...
class RobotPyWorkbench(FreeCADGui.Workbench):
    ...
    def Initialize(self):
        ...
        FreeCADGui.addCommand(
            "RobotPy_Robot_InsertKukaIR500", CmdRobotInsertKukaIR500()
        )
        FreeCADGui.addCommand("RobotPy_Robot_InsertKukaIR16", CmdRobotInsertKukaIR16())
        FreeCADGui.addCommand(
            "RobotPy_Robot_InsertKukaIR210", CmdRobotInsertKukaIR210()
        )
        FreeCADGui.addCommand(
            "RobotPy_Robot_InsertKukaIR125", CmdRobotInsertKukaIR125()
        )
        ...
        FreeCADGui.addCommand(
            "RobotPy_TrajectoryCompound", CmdCreateTrajectoryCompound()
        )
