...
TeachPointFold = (
";FOLD LIN P4  Vel= 0.2 m/s CPDAT1 Tool[1] Base[0];%{PE}%R 5.4.27,"
"%MKUKATPBASIS,%CMOVE,%VLIN,%P 1:LIN, 2:P4, 3:, 5:0.2, 7:CPDAT1\n" + 
"""
$BWDSTART = FALSE
LDAT_ACT=LCPDAT1
FDAT_ACT=FP4
...
TeachPointDat = (
"DECL E6POS XP4={X -25.1844196,Y 1122.42603,Z 1158.07996,"
"A -14.3267002,B 0.537901878,C 179.028305,S 6,T 59,"
